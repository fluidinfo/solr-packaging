...
public class PingRequestHandler extends RequestHandlerBase 
{
  ...
  public String getSourceId() {
    return "$Id: PingRequestHandler.java 1142180 2011-07-02 09:04:29Z uschindler $";
  }

  @Override
  public String getSource() {
    return "$URL: https://svn.apache.org/repos/asf/lucene/dev/branches/lucene_solr_3_4/solr/core/src/java/org/apache/solr/handler/PingRequestHandler.java $";
  }
}
