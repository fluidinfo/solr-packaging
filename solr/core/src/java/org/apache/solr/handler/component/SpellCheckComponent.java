...
public class SpellCheckComponent extends SearchComponent implements SolrCoreAware, SpellingParams {
  ...
  public String getVersion() {
    return "$Revision: 1133190 $";
  }

  @Override
  public String getSourceId() {
    return "$Id: SpellCheckComponent.java 1133190 2011-06-07 23:00:57Z rmuir $";
  }

  @Override
  public String getSource() {
    return "$URL: https://svn.apache.org/repos/asf/lucene/dev/branches/lucene_solr_3_4/solr/core/src/java/org/apache/solr/handler/component/SpellCheckComponent.java $";
  }
