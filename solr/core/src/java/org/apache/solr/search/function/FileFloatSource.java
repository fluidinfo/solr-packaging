 ...
 * @version $Id: FileFloatSource.java 1147288 2011-07-15 19:17:05Z hossman $
 */
...
public class FileFloatSource extends ValueSource {
  ...
  public static class ReloadCacheRequestHandler extends RequestHandlerBase {
    ...
    public String getSource() {
      return "$URL: https://svn.apache.org/repos/asf/lucene/dev/branches/lucene_solr_3_4/solr/core/src/java/org/apache/solr/search/function/FileFloatSource.java $";
    }

    @Override
    public String getSourceId() {
      return "$Id: FileFloatSource.java 1147288 2011-07-15 19:17:05Z hossman $";
    }

    @Override
    public String getVersion() {
      return "$Revision: 1147288 $";
    }    
  }
}
